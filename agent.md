...
`AGENTS.md` and the v5.9 audit files are authoritative. All version sections below are historical changelog entries; their old record counts and pending statements are not current.
